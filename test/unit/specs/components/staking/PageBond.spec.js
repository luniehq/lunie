...
describe("PageBond", () => {
  ...
  // you begin on the /staking page, so you end up going back to /
  // this may have to do w not being able to modify stake bug preventing you from getting
  // to the PageBond view?
