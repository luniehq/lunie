...
describe(`Module: Fee Distribution`, () => {
  ...
  describe(`Mutations`, () => {
    ...
    it(`sets the delegation rewards from a `, () => {
      ...
      mutations.setDelegationRewards(state, {
  ...
  describe(`Actions`, () => {
    ...
    describe(`getRewardsFromAllValidators`, () => {
      ...
      it(`fails`, async () => {
        ...
        await expect(actions.getRewardsFromAllValidators({
          state, dispatch
        }, validators)).rejects.toThrowError(`invalid address`)
      })
    ...
    describe(`getDistributionParameters`, () => {
      it(`success`, async () => {
        await actions.getDistributionParameters({
          state, rootState, commit
        })
    ...
    describe(`getOutstandingRewards`, () => {
      it(`success`, async () => {
        await actions.getOutstandingRewards({
          state, rootState, commit
        })
