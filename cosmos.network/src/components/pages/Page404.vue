<template lang="pug">
page(title="Error 404" subtitle="Page Not Found")
  text-container
    h2 Whoops!
    ...
    p Please notify us in #[a(:href="'mailto:' + links.cosmos.community.matrix") Developer Chat] and we will fix this error as soon as we can. Thank you for your patience.
</template>
