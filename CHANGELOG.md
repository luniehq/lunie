...
- [#2413](https://github.com/cosmos/lunie/issues/2413) Fix uptime not displaying @faboweb[Changed] [#2402](https://github.com/cosmos/lunie/pull/2402) Updated several dependencies + removed some + slimmed down tendermint-js @faboweb
