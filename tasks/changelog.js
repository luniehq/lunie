  ...
  const answer = await inquirer.prompt([
    {
      ...
      choices: [
        { name: `Addition of feature`, value: `Added` },
        { name: `Change of existing behavior`, value: `Changed` },
        { name: `Fix for a bug`, value: `Fixed` },
        { name: `Security improvement`, value: `Security` },
        { name: `Deprecation of unused code/feature`, value: `Deprecated` }
      ]
    },
    {
      type: `input`,
