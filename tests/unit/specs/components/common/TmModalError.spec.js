...
describe(`TmModalError`, () => {
  ...
  it(`has an icon`, () => {
    expect(
      wrapper.find(`.tm-modal-error__icon i.material-icons`).text().trim()
    ).toBe(`error_outline`)
  })
  ...
  it(`has a title`, () => {
    expect(wrapper.find(`.tm-modal-error__title`).text().trim()).toBe(
  ...
  it(`shows a title if specified`, () => {
    ...
    expect(wrapper.find(`.tm-modal-error__title`).text().trim()).toBe(`title-x`)
  })

  it(`has a body`, () => {
    expect(wrapper.find(`.tm-modal-error__body`).text().trim()).toContain(
  ...
  it(`shows a body if specified`, () => {
    ...
    expect(wrapper.find(`.tm-modal-error__body`).text().trim()).toBe(`body-x`)
  })
