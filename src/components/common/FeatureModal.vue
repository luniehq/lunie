<template>
  <TmModal :show="show">
    ...
    <ol>
      <li>
        <div><span>💸</span>Sikka changed their commission rate from 0%</div>
        <span>→</span>
      </li>
      <li>
        <div><span>🚨</span>Irresponsible Validator was just slashed 5%</div>
        <span>→</span>
      </li>
      <li>
        <div><span>🗳</span>Voting for proposal #24 ends in 1 hour</div>
        <span>→</span>
      </li>
    </ol>
