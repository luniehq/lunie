    ...
    <template v-if="validator" slot="managed-body">
      ...
      <ul class="row">
        ...
        <li>
          ...
          <span>{{ percent(validator.commission.commission_rates.rate) }}</span>
        </li>
        <li>
          <h4>Max Commission Rate</h4>
          <span>{{
            percent(validator.commission.commission_rates.max_rate)
          }}</span>
        </li>
        <li>
          <h4>Max Daily Commission Change</h4>
          <span>{{
            percent(validator.commission.commission_rates.max_change_rate)
          }}</span>
        </li>
        <li>
