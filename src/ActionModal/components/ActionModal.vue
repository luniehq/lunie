  ...
  >
    ...
    >
      ...
      >
        ...
        <p v-else-if="selectedSignMethod === `extension`">
          After submitting please click on the Lunie Browser Extension and
          approve the
          transaction.
        </p>
      </div>
...
const signWithExtension = `extension`
...
export default {
  ...
  computed: {
    ...
    selectedSignMethod() {
      ...
      if ((this.session.sessionType = "extension")) {
