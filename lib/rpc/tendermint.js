  ...
  const client = {
    ...
    pollConnection() {
      ...
      let connectionTimeout = setTimeout(
        function() {
          // prevent polling again for connection timeout
          clearInterval(this.pollInterval)
          // close the current websocket so we terminate the connection
          this.socket.close()
          // call a handler for the disconnect if this is desired
...
module.exports = tendermintConnect
