...
const LivepeerNodeSubscription = require('./livepeer-node-subscription')
...
const LivepeerV0API = require('./livepeerV0-source')
...
function startBlockHandlers() {
  ...
  new LivepeerNodeSubscription(
    networks['livepeer-mainnet'],
    LivepeerV0API,
    store['livepeer-mainnet']
  )
...
function createDataSources() {
  const dataSources = {
    ...
    LivepeerMainnetAPI: new LivepeerV0API(networks['livepeer-mainnet']),
