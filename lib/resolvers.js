...
async function validators(_, { networkId, addressList }, { dataSources }) {
  ...
  return await saturateValidatorsData(validators, networkId, dataSources);
}
...
async function saturateValidatorsData(validators, networkId, dataSources){
...
async function getValidatorData(address, networkId, dataSources){
...
const resolvers = {
  Query: {
    ...
    validators,
    validator: async ( _, { networkId, address }, { dataSources }) => getValidatorData(address, networkId, dataSources),
