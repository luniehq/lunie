...
const provisionShare = (votingPower, commission) => {
  const validatorProvisionShare = votingPower
  const delegatorProvisionShare = validatorProvisionShare * (1 - commission)
...
const expectedRewards = (
  ...
  const delegatorProvisionShare = provisionShare(
...
const expectedReturns = (validator, annualProvision, commission) => {
