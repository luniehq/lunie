<template lang="pug">
page(icon="storage" :title="`${validatorId} Delegators`")
  tool-bar
    router-link(
  ...
  part(title="Delegators / Time")
    | TODO: Chart

  part(title="Current Delegators (5)")
    list-item(title="Delegator Name" subtitle="137.4K ATOM" to="/delegators")
    list-item(title="Delegator Name" subtitle="137.4K ATOM" to="/delegators")
    list-item(title="Delegator Name" subtitle="137.4K ATOM" to="/delegators")
    list-item(title="Delegator Name" subtitle="137.4K ATOM" to="/delegators")
</template>
...
export default {
  name: 'page-validator-delegators',
  components: {
    ListItem,
    Page,
    Part,
